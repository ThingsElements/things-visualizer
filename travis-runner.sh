...
then
  git config --global user.email "heartyoh@hatiolab.com"
  ...
  deploy_ghpages () {
    # Deploying to GitHub Pages! (http://polymerelements.github.io/things-label)
    echo Deploying to GitHub Pages
    sed -i.tmp "s/\/\/ app.baseUrl = '\/things-label/app.baseUrl = '\/things-label/" app/scripts/app.js
  ...
  deploy_firebase () {
    # Deploying to Firebase! (https://things-label.firebaseapp.com)
    ...
    gulp
    # Starting Deploy Process to Firebaseapp.com Server -- things-label.firebaseapp.com
